      ...
      <div className="flex flex-col items-center gap-4">
        {!pause && (
          <Button
            onClick={startTimer}
            text="Start"
            className="rounded-md border-2 bg-transparent p-2 text-lg font-semibold uppercase hover:border-skin-border-primary hover:bg-transparent hover:text-skin-secondary-text active:bg-transparent"
          />
        )}
        {pause && (
          <div className="relative flex w-36 items-center justify-center">
            ...
            <Button
              ...
              className="absolute right-0 bg-transparent p-3 hover:bg-transparent active:bg-transparent"
            />
          </div>
        )}
